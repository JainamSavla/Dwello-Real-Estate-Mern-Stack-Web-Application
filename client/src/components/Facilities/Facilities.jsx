...
const Facilities = ({
  ...
  const { mutate, isLoading } = useMutation({
    mutationFn: () => {
      ...
      // Ensure userEmail is included in the data
      const dataToSend = {
        ...propertyDetails,
        facilities: { bedrooms, parkings, bathrooms },
        userEmail: user?.email, // Explicitly set the user email
      };

      console.log("Data with email:", dataToSend.userEmail);

      return createResidency(dataToSend, authToken);
    },
    onError: ({ response }) => {
